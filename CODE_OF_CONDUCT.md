...
We as members, contributors, and leaders of **KWT5H13LD** pledge to make participation in our community a harassment-free experience for everyone, regardless of age, body size, visible or invisible disability, ethnicity, sex characteristics, gender identity and expression, level of experience, education, socio-economic status, nationality, personal appearance, race, caste, color, religion, or sexual identity and orientation.
...
As a cybersecurity project, we hold ourselves to the highest ethical standards:

- **Never** use KWT5H13LD tools for unauthorized access or testing
- **Always** obtain proper authorization before running security assessments
- **Report** vulnerabilities responsibly through our [Security Policy](SECURITY.md)
